...
function borrar_libro($referencia)
{
    ...
    $respuesta["mensaje"] = "El producto con referencia: " . $referencia . " se ha borrado de la BD";
...
function crear_libro($datos)
{
    ...
    try {
        ...
        $sentencia = null;
        $conexion = null;
        $respuesta["error"] = "Error al realizarse la consulta crear libro: " . $e->getMessage();
        return $respuesta;
    }

    $respuesta["mensaje"] = "El libro con referencia: " . $datos[0] . " se ha creado correctamente";
...
function repetido_insertando($tabla, $columna, $valor)
{
    ...
    try {
        ...
        $sentencia = null;
        $conexion = null;
        $respuesta["error"] = "Error al realizarse la consulta repetido: " . $e->getMessage();
        return $respuesta;
    }
