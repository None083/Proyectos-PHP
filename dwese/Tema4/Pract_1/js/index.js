const DIR_API = "http://localhost/Proyectos/dwese/Tema3/SW/Actividad1/servicios_rest";
...
function validar_form_editar(cod, nombre_corto_original) {
    let nombre_corto = $('#nombre_corto').val().trim();

    if (nombre_corto === nombre_corto_original) {
        actualizar_producto(cod);
        return;
    }
...
function actualizar_producto(cod) {
