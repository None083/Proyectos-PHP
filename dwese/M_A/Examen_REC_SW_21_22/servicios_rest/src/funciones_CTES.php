...
function obtener_horario_grupo($id_grupo)
{
    ...
    try{
        $consulta="select horario_lectivo.dia, horario_lectivo.hora, usuarios.usuario, aulas.nombre as aula from horario_lectivo, usuarios, aulas where horario_lectivo.aula=aulas.id_aula and horario_lectivo.usuario=usuarios.id_usuario and horario_lectivo.grupo=?";
        $sentencia=$conexion->prepare($consulta);
...
function obtener_profesores($dia,$hora,$id_grupo)
{
    ...
    try{
        $consulta="select usuarios.id_usuario, usuarios.usuario, aulas.nombre as aula from horario_lectivo, usuarios, aulas where horario_lectivo.aula=aulas.id_aula and horario_lectivo.usuario=usuarios.id_usuario and horario_lectivo.grupo=? and dia=? and hora=?";
        $sentencia=$conexion->prepare($consulta);
        $sentencia->execute([$id_grupo,$dia,$hora]);
...
function obtener_profesores_libres($dia,$hora,$id_grupo)
{
    ...
    try{
        $consulta="select id_usuario, usuario from usuarios where usuario<>'admin' and id_usuario not in (select usuarios.id_usuario from horario_lectivo, usuarios, aulas where horario_lectivo.aula=aulas.id_aula and horario_lectivo.usuario=usuarios.id_usuario and horario_lectivo.grupo=? and dia=? and hora=?)";
        $sentencia=$conexion->prepare($consulta);
        $sentencia->execute([$id_grupo,$dia,$hora]);
