...
while($tupla = mysqli_fetch_assoc($datos_usuario)){
    ...
    echo "<td><form action='index.php' method='post'><button type='submit' class='enlace' value='".$tupla["id_usuario"]."' name='btnBorrar' title='Borrar usuario' alt='Borrar usuario'>Borrar</button> - <button type='submit' class='enlace' value='".$tupla["id_usuario"]."' name='btnEditar' title='Editar usuario' alt='Editar usuario'>Editar</button></form></td>";
    echo "</tr>";
}
echo "</table>";